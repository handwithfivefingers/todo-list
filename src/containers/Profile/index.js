...
const Profile = () => {
  ...
  //   axios
  //     .post(`/project/request/${req._id}`, form)
  //     .then((res) => {
  ...
  //   form.append('userId', user?._id);
  //   axios
  //     .post(`/project/refuse/${req._id}`, form)
  //     .then((res) => {
          ...
          {/* <Row gutter={[16, 12]}>
            <Col span={6} gutter={[16, 12]}>
              <Card style={{ padding: 0 }} bodyStyle={{ padding: 0 }}>
                ...
                >
                  <Collapse.Panel
                    header={
                      <h3 style={{ fontWeight: '500' }}>Thông tin cơ bản</h3>
                    }
                    key="1"
                    showArrow={true}
                  >
              ...
              <Card style={{ padding: 0 }} bodyStyle={{ padding: 0 }}>
                <Collapse accordion ghost expandIconPosition="right">
                  <Collapse.Panel
                    header={<h3 style={{ fontWeight: '500' }}>Bảo Mật</h3>}
                    key="21"
                    showArrow={true}
                  >
            ...
            <Col span={18}>
              ...
              >
                <Row>
                  <Col span={12}>
                    <Card title="Project cá nhân"></Card>
                  </Col>
                  <Col span={12}>
                    <Card title="Project Tham gia"></Card>
                  </Col>
                </Row>
              </Card>
            </Col>
